...
export function PromptSidebar() {
  ...
  return (
    <div
      ...
      style={{ backgroundColor: '#011E41', borderRight: '1px solid rgba(255,255,255,0.08)' }}
    >
      ...
      <div className="flex-1 overflow-y-auto p-4 sidebar-scroll">
        ...
        <div className="flex items-center justify-between mb-4">
          <p
            className="text-xs text-[#828282] uppercase tracking-widest"
        ...
        {PROMPT_GROUPS.map((group, gi) => (
          <div key={group.label}>
            <p
              className={`text-[10px] uppercase tracking-widest text-[#828282] mb-2 ${gi === 0 ? 'mt-0' : 'mt-5'}`}
              style={{ fontFamily: "'Helvetica Now Text', 'Helvetica Neue', Helvetica, Arial, sans-serif", fontWeight: 700 }}
            >
              {group.label}
            </p>
            <hr className="mb-3" style={{ borderColor: 'rgba(255,255,255,0.06)' }} />
      ...
      >
        <p
          className="text-[10px] uppercase tracking-widest text-[#828282] mb-2"
          style={{ fontFamily: "'Helvetica Now Text', 'Helvetica Neue', Helvetica, Arial, sans-serif", fontWeight: 700 }}
        >
          Session History
        </p>
        {recentHistory.length === 0 ? (
          <p
            className="text-[11px] text-[#4F4F4F] italic"
          ...
          <AnimatePresence>
            {recentHistory.map((entry, index) => (
              <motion.button
                ...
                className="block w-full text-left text-[11px] text-[#828282] hover:text-white cursor-pointer py-0.5 truncate transition-colors"
                style={{ fontFamily: "'Helvetica Now Text', 'Helvetica Neue', Helvetica, Arial, sans-serif" }}
